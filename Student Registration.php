...
$sql= "INSERT INTO `dowell university`.`students` (`FirstName`, `LastName`, `Email`, `SID`, `Password`, `Adderess`, `PhoneNumber`, `DOB`,`semester`,`campus`,`Date of Registration`) 
VALUES ('$fname', '$lname', '$email', '$sid', '$securepass', '$adderess', '$phone', '$dob', '$semester','$campus',current_timestamp());";
