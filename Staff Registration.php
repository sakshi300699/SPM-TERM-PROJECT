...
//     }
   ...
   //echo $campus;
   //echo $semester;
   // sql query to insert values in the databases from the values recievied
   $sql= "INSERT INTO `dowell university`.`staff` (`FirstName`, `LastName`, `email`, `sid`, `subject` ,`password`, `adderess`, `phone`, `dob`) VALUES ('$fname', '$lname', '$email', '$sid', '$subject' ,'$securepass', '$adderess', '$phone', '$dob');";
   
   if($con->query($sql) == true){
           //if the query return true
        echo "<h3 style='margin-left:400px;margin-top:20px;color:green' >You have successfully registered<a href='staffLogin.php'>Go back to Login Page</a></h3>";
   }
   else{
           //showing error
