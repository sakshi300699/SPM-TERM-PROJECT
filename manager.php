<?php
        ...
        //getting id from URL
         ...
         $query= "INSERT INTO `timetabble`(`CID`,`Day1`,`Day2`,`Day3`,`time`) VALUES('$id','$day1','$day2','$day3','$time');";
         if($con->query($query))    echo"<h3 style='color:green'>Successfully Entered</h3>";
         else   echo $con->error;
    }
?>
...
<html lang="en" dir="ltr">
  ...
  <form id="regform" method="post">
      <h2 style="margin-left:680px">Manage</h2>
